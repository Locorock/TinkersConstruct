...
{
    static String[] names = new String[] { "iron", "gold", "copper", "tin", "aluminum", "essence", "diamond" };
    static String[] tex = new String[] { "oreberry_iron", "oreberry_gold", "oreberry_copper", "oreberry_tin", "oreberry_aluminum", "oreberry_essence", "oreberry_diamond" };
